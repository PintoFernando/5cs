...
-->
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li id="liArchivos" class="treeview">
            ...
            <ul class="treeview-menu">
              <li id="liFotos"><a href="{{url('/oficial/foto/')}}"><i class="fa fa-pencil"></i>Seguimiento Fotografico</a></li>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="{{url('/riesgos/consumo_sola_firma/')}}"><i class="fa fa-file-word-o text-aqua"></i> <span>Informe A Sola Firma</span></a></li>
              <li><a href="{{url('/riesgos/hipotecaria/')}}"><i class="fa fa-file-word-o text-aqua"></i> <span>Informe C. G. Hipotecaria</span></a></li>
              <li><a href="{{url('/riesgos/garantes/')}}"><i class="fa fa-file-word-o text-aqua"></i> <span>Informe C. Garantes</span></a></li>
              <li><a href="{{url('/riesgos/prendaria/')}}"><i class="fa fa-file-word-o text-aqua"></i> <span>Informe C. G. Prendaria</span></a></li>
            </ul>
          </li>
