...
<li id="liGarante" class="treeview">
  ...
  <ul class="treeview-menu">
    ...
    <li id="liGarante_sub_inventario"><a href="{{url('/oficial/a_garantes/inventario_mercaderia/create')}}"><i class="@if(\sis5cs\InventarioMercaderia::where('id_persona',Session::get('id_persona_garante'))->count()>0) fa fa-edit text-lime  @else fa fa-pencil @endif"></i>Inventario Mercadería</a></li>
