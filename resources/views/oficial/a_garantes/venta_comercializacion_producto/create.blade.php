...
<section class="content">
  ...
  <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
    <div class="form-group">     
     <a href="{{url('oficial/venta_comercializacion_producto/descarga')}}"><button type="button" class="btn btn-primary btn">Descargar</button></a>  
   </div>
 </div> 
</section>
...
<section class="content">
  ...
  <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
    <div class="form-group">     
     <a href="{{url('oficial/venta_comercializacion_producto/descarga_transporte')}}"><button type="button" class="btn btn-primary btn">Descargar</button></a>  
   </div>
 </div> 
</section>
...
<section class="content">
  ...
  <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
    <div class="form-group">     
     <a href="{{url('oficial/venta_comercializacion_producto/comercio')}}"><button type="button" class="btn btn-primary btn">Descargar</button></a>  
   </div>
 </div> 
</section>
...
<section class="content">
 ...
 <div class="callout callout-success">
  ...
  <form method="post" action="{{url('oficial/a_garantes/venta_comercializacion_producto/')}}" enctype="multipart/form-data">
    {{csrf_field()}}
