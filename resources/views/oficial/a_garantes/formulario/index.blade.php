...
<table  style="width:100%"  border="2">
  <thead>
    <tr>
      <th width="80" colspan="6" class="table-celda-verde"><h7><strong>INFORMACIÓN GENERAL DEL GARANTE</strong></h7></th>
    </tr>
    <tr>
...
<table  style="width:100%"  border="2">
  <thead>
    <tr>
      <th width="80" colspan="8" class="table-celda-verde"><h7><strong>DIRECCIÓN DOMICILIARIA DEL GARANTE</strong></h7></th>
    </tr>
    <tr>
...
<table  style="width:100%"  border="2">
  <thead>
    <tr>
      ...
      TRABAJA EL GARANTE </strong></h7></th>
    </tr>
    <tr >
      <th class="table-celda-naranja">Ciudad</th>
      <th class="table-celda-naranja">Provincia</th>
...
<table  style="width:100%"  border="2">
  <thead>
   <tr>
    <th colspan="8" class="table-celda-verde"><h7><strong>DEPÓSITOS BANCARIOS</strong></h7></th>
  </tr>
  <tr >
...
<table  style="width:100%"  border="2">
 ...
 <tbody>
  ...
  <tr>
   ...
   <td >@if($in->en_garantia) Si @else No @endif </td>
   <td >{{$in->detalle}} </td>
...
<?php
$v_ap_casada=\sis5cs\Persona::where('id_persona',Session::get('id_persona_garante'))->get();
?>

<?php
$existe_conyugue = \sis5cs\Conyugue::where('id_persona', Session::get('id_persona_garante'))->count();
if ($existe_conyugue > 0) {
    $id_conyugue = \sis5cs\Conyugue::where('id_persona', Session::get('id_persona_garante'))->firstOrFail()->conyugue;
   }
?>
<tr>
