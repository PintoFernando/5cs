 ...
 <div class="form-group">   
  <label>Crear PDF</label>
   <div style="width: 30%"> 
    ...
    <div align="right"><input type="submit" class="btn btn-primary"  value="Buscar" ></div> <p></p>
    <select  name="id_tipocroquis" class="form-control selectpicker" data-size="5" id="id_tipocroquis" data-live-search="true" ></div>
      <option value="100" >---Seleccione El Tipo de Croquis---</option>
