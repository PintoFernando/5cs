...
<form method="" action="{{url('oficial/foto/'.$id_opcion_pdf.'/vistacroquis2/')}}" enctype="multipart/form-data">
 ...
 <option value="100" selected>---Seleccione Una Carpeta de Fotos---</option>
