...
<form method="" action="{{url('oficial/foto/'.$id_opcion_pdf.'/prueba2/')}}" enctype="multipart/form-data" >

 <div class="form-group">   
    <label>Crear PDF</label>
      <div style="width: 30%"> 
      <select  name="id_opcion_croquis_pdf" class="form-control selectpicker" data-size="5" id="id_opcion_croquis_pdf" data-live-search="true" >
      </div>
