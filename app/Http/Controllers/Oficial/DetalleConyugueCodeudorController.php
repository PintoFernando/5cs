...
class DetalleConyugueCodeudorController extends Controller
{
    ...
    {
        $id = Conyugue::where('id_persona', Session::get('id_persona_codeudor'))->firstOrFail()->conyugue;
    ...
    public function create()
    {
        if (Session::get('id_persona_codeudor') == null) {
            ...
            $id = Conyugue::where('id_persona', Session::get('id_persona_codeudor'))->count();
            if ($id > 0) {
    ...
    {
        //id_conyugue
        $id_conyugue = Conyugue::where('id_persona', Session::get('id_persona_codeudor'))->firstOrFail();
