...
class GastosOperativosComercializacionGaranteController extends Controller
{
  ...
  public function index(Request $request)
  {
   ...
   {
    $gastos=GastosOperativosComercializacion::where('id_persona',Session::get('id_persona_garante'))->get();
...
{    
 ...
 {
  $if_exist=GastosOperativosComercializacion::where('id_persona',Session::get('id_persona_garante'))->count();
  if($if_exist>0)
  {
