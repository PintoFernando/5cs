...
class DetalleConyugueGaranteController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $id = Conyugue::where('id_persona', Session::get('id_persona_garante'))->firstOrFail()->conyugue;
    ...
    public function create()
    {
        if (Session::get('id_persona_garante') == null) {
            ...
            $id = Conyugue::where('id_persona', Session::get('id_persona_garante'))->count();
            if ($id > 0) {
    ...
    {
        //id_conyugue
        $id_conyugue = Conyugue::where('id_persona', Session::get('id_persona_garante'))->firstOrFail();
