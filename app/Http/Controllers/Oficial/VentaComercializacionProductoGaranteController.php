...
class VentaComercializacionProductoGaranteController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($this->id_persona_garante == null) {
            ...
            $venta = VentaComercializacionProducto::where('id_persona', $this->id_persona_garante)->get();
    ...
    public function import(Request $request)
    {
        ...
        Excel::selectSheets('calculo')->load($request->costo_ventas, function ($reader) {
            ...
            $reader->each(function ($row) {
                ...
                $venta->id_persona = $this->id_persona_garante;
                $venta->save();
            });
        });
    ...
    public function create()
    {
        if (Session::get('id_persona_garante') == null) {
            ...
            $if_exist = VentaComercializacionProducto::where('id_persona', Session::get('id_persona_garante'))->count();
            if ($if_exist > 100) {
