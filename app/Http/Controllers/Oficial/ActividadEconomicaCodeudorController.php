...
class ActividadEconomicaCodeudorController extends Controller
{
    ...
    public function index(Request $request)
    {
        if (Session::get('id_persona_codeudor') == null) {
            ...
            $actividad = ActividadEconomica::where('id_persona', Session::get('id_persona_codeudor'))->get();
    ...
    public function create()
    {
        if (Session::get('id_persona_codeudor') == null) {
            ...
            $if_exist = ActividadEconomica::where('id_persona', Session::get('id_persona_codeudor'))->count();
            if ($if_exist > 0) {
